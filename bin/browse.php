...
/*
     En este archivo que está escaneando las carpetas de imágenes y
     devolver un objeto JSON con nombres de archivo. Es utilizado por
     jQuery para mostrar las imágenes de la portada:
*/
