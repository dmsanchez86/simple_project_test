...
<!-- Popup de Retrasmitete -->
<div  id="transmit" class="transmit" style="padding:0px;">
  <div class="content_box">
    <span class="close_pop">X</span>
    <form id="retrans" method="post" action="#retrans">  
      <p id="login_error" style="font-family: Calibri;color: #111; font-size:25px;font-weight:bold; text-align:center;margin-bottom: 3rem">
        Aviso Legal en Retransmisi&oacuten
      </p>
      <div class="content_terms">
        <h2>Términos y Condiciones</h2>
        <div class="text">
          <p>Emisor: si: (i) no tiene por lo menos 18 años de edad o mayores de edad en su jurisdicción en la que usted puede exponer el material sexualmente explícito, (ii) dicho material le ofende, o (iii) de ver el material sexualmente explícito no es legal en su comunidad o país donde  elige para exponer.
          Al optar por entrar en este sitio web  está afirmando que todas las siguientes declaraciones son verdaderas y correctas aplicables:
          </p>
          <ul>
            <li>He alcanzado la mayoría de edad en mi jurisdicción;</li>
            <li>El material sexualmente explícito que voy a exponer será público y no voy a exponer a los menores en este sitio web;</li>
            <li>Deseo exponer / exponer material sexualmente explícito;</li>
            <li>Creo que como adulto es mi derecho constitucional inalienable a exponer / exponer material sexualmente explícito;</li>
            <li>Creo que los actos sexuales entre adultos que consienten no son ni ofensivos ni obscenos;</li>
            <li>La visualización, lectura y descarga de material sexualmente explícito no viola los estándares de cualquier comunidad, pueblo, ciudad, estado o país donde lo visualizaré, leeré y / o descargue los materiales sexualmente explícitos;</li>
            <li>Yo soy el único responsable de cualquier revelación o ramificaciones legales de ver, leer o descargar cualquier material que aparezca en este sitio. También estoy de acuerdo que ni este sitio ni sus filiales serán responsables por cualquier ramificación legal que surjan de cualquier entrada fraudulenta en o el uso de este sitio web;</li>
            <li>Entiendo que mi uso de este sitio web se rige por Términos del sitio web que he revisado y aceptado, y yo estoy de acuerdo en estar obligado por estos Términos.</li>
          ...
          <p>
            Contenido: El Contenido en directo debe cumplir los términos y condiciones de la comunidad de LubriCam. Sin perjuicio de lo establecido en los términos y condiciones de este sitio web, afirmas y garantizas cumplir dichas normas, disponiendo de todos los derechos de uso del Contenido en directo  para todo el mundo, incluidos (entre otros) los derechos de licencia musical de los artistas, sellos discográficos, distribuidores (incluidas las licencias de interpretación pública) y otras partes implicadas en las regalías. Confirmas que aceptas cumplir la normativa y regulación vigentes relacionadas con el Contenido en directo. Dicho contenido y el Contenido archivado (si lo hubiera) constituyen el "Contenido del proveedor", "Contenido del canal original" o "Tu contenido" (si procede), de acuerdo con lo establecido en el Acuerdo con LubriCam. Dicho contenido está sujeto a los términos de tal Acuerdo. El proveedor garantiza que ha satisfecho todos los requisitos normativos del ámbito de las emisiones en directo, incluidos (entre otros) todos los requisitos relacionados con licencias, registros o notificaciones; y mantendrá dichas licencias (incluidas las de emisión), registros, consentimientos, notificaciones o aprobaciones mientras estos Términos relacionados con las Emisiones en directo sigan vigentes.
          </p>

          <p>
            En ésta web se coopera activamente con la aplicación de la ley y supuestos casos de sospecha de uso ilegal del servicio, en especial en el uso ilegal del servicio por menores de edad.
          </p>
        </div>
      </div>
      <div class="container_buttons">
        <button class="btn" id="btn_go_out_transmit" type="button" style="max-width: 140px;">SALIR</button>
        <button class="btn" id="btn_enter_transmit" type="button" style="max-width: 140px;">ENTRAR</button>
      </div>
    </form>
    <div class="container_img">
      <img src="img/seguridad.png"></img>
